...
export const ENGINE_REGISTRY: EngineDef[] = [
  ...
  { id: "vip", label: "VIP", description: "VIP grants, status, expiry cleanup, and tier lifecycle", group: "Access", route: "/dashboard/vip", notes: "Separate VIP engine. Loyalty is configured on its own linked page." },
