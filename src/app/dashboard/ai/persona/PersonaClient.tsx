        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          <div>
            ...
            <div style={{ color: "#ffb5b5", fontSize: 12, marginTop: 8, maxWidth: 880 }}>
              ...
              It is separate from the handcrafted learning assistant and the provider/pricing surface. Use this page to inspect the real persona roster and runtime mode.
            </div>
          </div>
      ...
      {!loading ? (
        <>
          ...
          <section style={card}>
            ...
            <div style={{ color: "#ffdada", fontWeight: 700 }}>The persona engine is separate from the learning assistant.</div>
            <div style={{ color: "#ffbdbd", fontSize: 12, marginTop: 4 }}>
              ...
              The handcrafted learning assistant runs separately on the non-persona path, and provider pricing, public catalog, and billing belong to the OpenAI platform page instead.
            </div>
          </section>
