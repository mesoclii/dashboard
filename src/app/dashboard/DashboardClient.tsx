...
const CARDS: Card[] = [
  ...
  { href: "/dashboard/profile", title: "Profile", description: "Profile display, rank surfaces, and stat aggregation controls.", toggle: entityController("engine/profileEngine.js") },
  { href: "/dashboard/halloffame", title: "Hall of Fame", description: "Recognition layer for top achievers and prestige-ready members.", toggle: entityController("engine/hallOfFameEngine.js") },
